...
const ru = {
  ...
  welcome: {
    headline:    'Куда вы можете поехать?',
    description: 'Выберите паспорт — каждая страна окрасится в цвет, соответствующий условиям въезда.',
    step1:       'Нажмите на иконку человека в левой панели',
    step2:       'Добавьте один или несколько паспортов (до трёх)',
    step3:       'Нажмите на любую страну, чтобы увидеть условия въезда',
    cta:         'Открыть вкладку «Документы»',
  },
  language: {
    en: 'English',
    ru: 'Русский',
